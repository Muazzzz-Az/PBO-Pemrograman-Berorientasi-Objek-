...
public class ArtistController {
    ...
    // GET artist by ID — dibutuhkan frontend ArtistService.getById()
    @GetMapping("/{id}")
    ...
    // GET artist by category — dibutuhkan frontend ArtistService.getByCategory()
    ...
    // PUT update artist — dibutuhkan untuk verifikasi admin
    @PutMapping("/{id}")
